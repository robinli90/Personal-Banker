...
namespace Financial_Journal
{
    public partial class Yes_No_Dialog : Form
    {
        ...
        public Yes_No_Dialog(Receipt _parent, string Dialog_Message, string Title, string no_button_text = "No", string yes_button_text = "Yes", int grow_height = 0, Point g = new Point(), Size s = new Size())
        {
